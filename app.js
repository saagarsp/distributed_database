...
createDatabase()
  ...
  // Assume your Cosmos DB data is available in the config.items object

document.addEventListener('DOMContentLoaded', function () {
  // Populate Users
  const usersList = document.getElementById('usersList');
  for (const userKey in config.items) {
      const user = config.items[userKey];
  ...
  // Similar logic for Courses and Enrollment Dates
});
